...
| --- | ---: | ---: | ---: | ---: |
| train | 0.6154 | 162/162 = 1.0000 | 152/152 = 1.0000 | 10/10 = 1.0000 |
`train` source counts: hsv=64, label=98
| test | 0.4900 | 332/333 = 0.9970 | 305/306 = 0.9967 | 27/27 = 1.0000 |
`test` source counts: hsv=183, label=149
...
| C_geometry | 1.0000 | 0.7900 | 0.9615 | 0.9564 | 0.9666 | 2 | 1 | 1 | 0 |

## Selected Configs

- `C_geometry`: `topK=25, region=8, stack=8, atom=0, temp=1, tau=0, min_conf=0.5, changed=root_and_stack`
...
| C_geometry | 27 | 9 | 17 | 1 | 0 |

## Changed Images

### C_geometry
changed-edge evidence: 3/3 = 1.0000
- changed: 2
  picture_307(gold_topK=True), picture_336(gold_topK=True)
- bad_to_good: 1
  picture_307(gold_topK=True)
- good_to_bad: 1
  picture_336(gold_topK=True)
- bad_to_bad: 0
