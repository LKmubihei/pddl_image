...
| C_geometry | 1.0000 | 0.8000 | 0.9627 | 0.9575 | 0.9678 | 1 | 1 | 0 | 0 |

## Selected Configs

- `C_geometry`: `topK=25, region=8, stack=8, atom=0, temp=1, tau=0.5, min_conf=0.5, changed=root_and_stack`
...
| C_geometry | 26 | 9 | 16 | 1 | 0 |

## Changed Images

### C_geometry
changed-edge evidence: 2/2 = 1.0000
- changed: 1
